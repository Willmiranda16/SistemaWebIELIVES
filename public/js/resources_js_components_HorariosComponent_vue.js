(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_components_HorariosComponent_vue"],{

/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/HorariosComponent.vue?vue&type=script&lang=js&":
/*!************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/HorariosComponent.vue?vue&type=script&lang=js& ***!
  \************************************************************************************************************************************************************************************************************/
...
/* harmony import */ var _fullcalendar_daygrid__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @fullcalendar/daygrid */ "./node_modules/@fullcalendar/daygrid/index.esm.js");
/* harmony import */ var _fullcalendar_timegrid__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @fullcalendar/timegrid */ "./node_modules/@fullcalendar/timegrid/index.esm.js");
/* harmony import */ var _fullcalendar_interaction__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @fullcalendar/interaction */ "./node_modules/@fullcalendar/interaction/index.esm.js");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  data: function data() {
    ...
    return _ref = {
      ...
      data: [],
      horarios: {}
    }, _defineProperty(_ref, "cursos", {}), _defineProperty(_ref, "horario", {
      año: '0',
      nivel: '0',
      grado: '0',
      seccion: '0',
      ...
      color: '0',
      editable: 'false'
    }), _defineProperty(_ref, "calendarOptionsPrimaria", {
    ...
    }), _defineProperty(_ref, "calendarOptionsSecundaria", {
      plugins: [_fullcalendar_daygrid__WEBPACK_IMPORTED_MODULE_2__["default"], _fullcalendar_timegrid__WEBPACK_IMPORTED_MODULE_3__["default"], _fullcalendar_interaction__WEBPACK_IMPORTED_MODULE_4__["default"]],
      headerToolbar: {
        left: "prev,next today",
        center: "",
    ...
    }), _defineProperty(_ref, "loading", false), _defineProperty(_ref, "loading1", false), _defineProperty(_ref, "buscando", false), _ref;
  },
  ...
  methods: {
    agregar_horario: function agregar_horario() {
      var _this3 = this;
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _this3.loading1 = true;
                axios.post("/api/agregar-horarios", {
                  params: {
                    horario: _this3.horario
                  }
                }).then(function (response) {
                  setTimeout(function () {
                    ...
                    sweetalert__WEBPACK_IMPORTED_MODULE_0___default()({
                      ...
                      _this3.limpiar_campos();

                      _this3.buscar_horarios();
                    });
                  }, 1000);
                })["catch"](function (error) {
                  console.log(error);
    ...
    actualizar_horario: function actualizar_horario(info) {
      var _this4 = this;
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                console.log(info);
                _this4.loading1 = true;
                axios.post("/api/agregar-horarios", {
                  params: {
                    horario: _this4.horario
                  }
                }).then(function (response) {
                  setTimeout(function () {
                    ...
                    sweetalert__WEBPACK_IMPORTED_MODULE_0___default()({
                      ...
                      _this4.limpiar_campos();

                      _this4.buscar_horarios();
                    });
                  }, 1000);
                })["catch"](function (error) {
                  console.log(error);
    ...
    listar_años: function listar_años() {
      var _this5 = this;
        ...
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                axios.get("/api/listar-anios").then(function (response) {
                  _this5.años = response.data;
                })["catch"](function (error) {
                  console.log(error);
                });
            ...
            switch (_context4.prev = _context4.next) {
              case 0:
                axios.get("/api/listar-niveles").then(function (response) {
                  _this6.ocultar_lista(), _this6.niveles = response.data;
                })["catch"](function (error) {
                  console.log(error);
                });
    ...
    listar_docentes: function listar_docentes() {
      var _this7 = this;
            ...
            switch (_context5.prev = _context5.next) {
              case 0:
                axios.post("/api/listar-docentes-all", {
                  params: {
                    nivel: _this7.horario.nivel
                  }
                }).then(function (response) {
                  _this7.horario.docente = '0', _this7.horario.grado = '0', _this7.horario.seccion = '0', _this7.docentes = response.data.docente, _this7.ocultar_lista();
                })["catch"](function (error) {
                  console.log(error);
                });
            ...
            switch (_context6.prev = _context6.next) {
              case 0:
                axios.post("/api/listar-grados", {
                  params: {
                    id: _this8.horario.nivel
                  }
                }).then(function (response) {
                  _this8.horario.grado = '0', _this8.horario.seccion = '0', _this8.grados = response.data, _this8.ocultar_lista();
                })["catch"](function (error) {
                  console.log(error);
                });
            ...
            switch (_context7.prev = _context7.next) {
              case 0:
                axios.post("/api/listar-secciones", {
                  params: {
                    id: _this9.horario.grado
                  }
                }).then(function (response) {
                  _this9.horario.seccion = '0', _this9.secciones = response.data, _this9.ocultar_lista();
                })["catch"](function (error) {
                  console.log(error);
                });
    ...
    buscar_horarios: function buscar_horarios() {
      var _this10 = this;
        ...
        return _regeneratorRuntime().wrap(function _callee8$(_context8) {
          while (1) {
            switch (_context8.prev = _context8.next) {
              case 0:
                _this10.buscando = true;
                _this10.loading = true;
                axios.post("/api/listar-horarios", {
                  params: {
                    horario: _this10.horario
                  }
                }).then(function (response) {
                  setTimeout(function () {
                    _this10.horarios = response.data.horarios;
                    _this10.cursos = response.data.cursos;
                    _this10.data = [];
                    response.data.horarios.forEach(function (e) {
                      var object = {
                        id: e.hor_id,
                        title: e.curso,
        ...
        return _regeneratorRuntime().wrap(function _callee9$(_context9) {
          while (1) {
            switch (_context9.prev = _context9.next) {
              case 0:
                if (_this11.horario.nivel == 0 && _this11.horario.grado == 0 && _this11.horario.seccion == 0) {
                  div = document.getElementById("mostrar-info").classList;
                  div.add("d-none");
                } else if (_this11.horario.nivel != 0 && _this11.horario.grado == 0 && _this11.horario.seccion == 0) {
                  _div = document.getElementById("mostrar-info").classList;

                  _div.add("d-none");
                } else if (_this11.horario.nivel != 0 && _this11.horario.grado == 0 && _this11.horario.seccion == 0) {
                  _div2 = document.getElementById("mostrar-info").classList;

                  _div2.add("d-none");
                } else if (_this11.horario.nivel != 0 && _this11.horario.grado != 0 && _this11.horario.seccion == 0) {
                  _div3 = document.getElementById("mostrar-info").classList;

                  _div3.add("d-none");
                } else {
                  _div4 = document.getElementById("mostrar-info").classList;
        ...
        return _regeneratorRuntime().wrap(function _callee10$(_context10) {
          while (1) {
            switch (_context10.prev = _context10.next) {
              case 0:
                _this12.horario.fecha = '', _this12.horario.hora_inicio = '', _this12.horario.hora_fin = '', _this12.horario.color = '0', _this12.horario.curso = '0';
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/HorariosComponent.vue?vue&type=template&id=16e48b5e&":
/*!***********************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/HorariosComponent.vue?vue&type=template&id=16e48b5e& ***!
  \***********************************************************************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var render = function render() {
  ...
  return _c("div", [_vm._m(0), _vm._v(" "), _c("div", {
    ...
    directives: [{
      name: "model",
      rawName: "v-model",
      value: _vm.horario.año,
      expression: "horario.año"
    }],
    ...
    on: {
      change: [function ($event) {
        ...
        _vm.$set(_vm.horario, "año", $event.target.multiple ? $$selectedVal : $$selectedVal[0]);
      }, function ($event) {
        return _vm.listar_niveles();
      }]
    }
  }, [_c("option", {
    attrs: {
  ...
  }, [_vm._v("-- Selecciona --")]), _vm._v(" "), _vm._l(_vm.años, function (n) {
    return _c("option", {
      key: n.id,
      domProps: {
        value: n.año_id
    ...
    directives: [{
      name: "model",
      rawName: "v-model",
      value: _vm.horario.nivel,
      expression: "horario.nivel"
    }],
    staticClass: "form-control show-tick",
    on: {
      change: [function ($event) {
        ...
        _vm.$set(_vm.horario, "nivel", $event.target.multiple ? $$selectedVal : $$selectedVal[0]);
      }, function ($event) {
    ...
    directives: [{
      name: "model",
      rawName: "v-model",
      value: _vm.horario.grado,
      expression: "horario.grado"
    }],
    staticClass: "form-control show-tick",
    on: {
      change: [function ($event) {
        ...
        _vm.$set(_vm.horario, "grado", $event.target.multiple ? $$selectedVal : $$selectedVal[0]);
      }, function ($event) {
        return _vm.listar_secciones();
      }]
    }
  }, [_vm.grados.length == 0 ? _c("option", {
    attrs: {
      value: "0",
      selected: "",
      disabled: ""
  ...
  }, [_vm._v("-- Selecciona --")]), _vm._v(" "), _vm._l(_vm.grados, function (n) {
    return _c("option", {
      key: n.id,
      domProps: {
        value: n.gra_id
    ...
    directives: [{
      name: "model",
      rawName: "v-model",
      value: _vm.horario.seccion,
      expression: "horario.seccion"
    }],
    staticClass: "form-control show-tick",
    on: {
      change: function change($event) {
        ...
        _vm.$set(_vm.horario, "seccion", $event.target.multiple ? $$selectedVal : $$selectedVal[0]);
      }
    }
  ...
  }, [_vm._v("-- Selecciona --")]), _vm._v(" "), _vm._l(_vm.secciones, function (n) {
    return _c("option", {
      key: n.id,
      domProps: {
        value: n.sec_id
    ...
    on: {
      click: function click($event) {
        return _vm.buscar_horarios();
      }
    }
  }, [_vm._v("Cargar Información")]) : _c("a", {
    staticClass: "btn btn-sm btn-primary btn-block",
    attrs: {
      href: "javascript:void(0);",
      title: ""
    }
  }, [_vm._v("Procesando...")])])])])]), _vm._v(" "), _c("div", {
    ...
    staticClass: "col-md-3 p-4"
  }, [_c("form", {
    staticClass: "card p-3",
    on: {
      submit: function submit($event) {
        $event.preventDefault();
        return _vm.agregar_horario.apply(null, arguments);
      }
    }
  }, [_c("div", {
    staticClass: "row"
  ...
  }, [_c("label", [_vm._v("Curso")]), _vm._v(" "), _c("select", {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: _vm.horario.curso,
      expression: "horario.curso"
    }],
    staticClass: "form-control show-tick",
    on: {
      change: function change($event) {
        ...
        _vm.$set(_vm.horario, "curso", $event.target.multiple ? $$selectedVal : $$selectedVal[0]);
      }
    }
  }, [_c("option", {
    attrs: {
  ...
  }, [_vm._v("-- Selecciona --")]), _vm._v(" "), _vm._l(_vm.cursos, function (c) {
    return _c("option", {
      key: c.id,
      domProps: {
        value: c.cur_id
      }
    }, [_vm._v("\n                                                            " + _vm._s(c.cur_abreviatura) + "\n                                                        ")]);
  })], 2)])]), _vm._v(" "), _c("div", {
    staticClass: "col-lg-12 col-md-6 col-sm-12"
  }, [_c("div", {
    staticClass: "form-group"
  }, [_c("label", [_vm._v("Fecha")]), _vm._v(" "), _c("div", {
    staticClass: "input-group mb-3"
  }, [_c("input", {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: _vm.horario.fecha,
    ...
    on: {
      input: function input($event) {
        ...
        _vm.$set(_vm.horario, "fecha", $event.target.value);
      }
    }
  })])])]), _vm._v(" "), _c("div", {
    staticClass: "col-lg-12 col-md-6 col-sm-12"
    ...
    staticClass: "form-group"
  }, [_c("label", [_vm._v("Hora Inicio")]), _vm._v(" "), _c("div", {
    staticClass: "input-group mb-3"
  }, [_c("input", {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: _vm.horario.hora_inicio,
      expression: "horario.hora_inicio"
    }],
    staticClass: "form-control",
    attrs: {
      type: "time",
    ...
    on: {
      input: function input($event) {
        ...
        _vm.$set(_vm.horario, "hora_inicio", $event.target.value);
      }
    }
  })])])]), _vm._v(" "), _c("div", {
    staticClass: "col-lg-12 col-md-6 col-sm-12"
    ...
    staticClass: "form-group"
  }, [_c("label", [_vm._v("Hora Fin")]), _vm._v(" "), _c("div", {
    staticClass: "input-group mb-3"
  }, [_c("input", {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: _vm.horario.hora_fin,
      expression: "horario.hora_fin"
    }],
    staticClass: "form-control",
    attrs: {
      type: "time",
    ...
    on: {
      input: function input($event) {
        ...
        _vm.$set(_vm.horario, "hora_fin", $event.target.value);
      }
    }
  })])])]), _vm._v(" "), _c("div", {
    staticClass: "col-lg-12 col-md-6 col-sm-12"
    ...
    staticClass: "form-group"
  }, [_c("label", [_vm._v("Color")]), _vm._v(" "), _c("div", {
    staticClass: "input-group mb-3"
  }, [_c("select", {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: _vm.horario.color,
      expression: "horario.color"
    }],
    staticClass: "form-control show-tick",
    attrs: {
      required: ""
    ...
    on: {
      change: function change($event) {
        ...
        _vm.$set(_vm.horario, "color", $event.target.multiple ? $$selectedVal : $$selectedVal[0]);
      }
    }
  }, [_c("option", {
    attrs: {
  ...
  }, [_vm._v("Rojo")]), _vm._v(" "), _c("option", {
    attrs: {
      value: "blue"
    }
  }, [_vm._v("Azul")]), _vm._v(" "), _c("option", {
    attrs: {
      value: "green"
    }
  }, [_vm._v("Verde")]), _vm._v(" "), _c("option", {
    attrs: {
      value: "purple"
    }
  }, [_vm._v("Morado")]), _vm._v(" "), _c("option", {
    attrs: {
      value: "orange"
    }
  }, [_vm._v("Naranja")]), _vm._v(" "), _c("option", {
    attrs: {
      value: "turquiose"
    }
  }, [_vm._v("Turquesa")]), _vm._v(" "), _c("option", {
    attrs: {
      value: "brown"
    }
  }, [_vm._v("Marrón")]), _vm._v(" "), _c("option", {
    attrs: {
      value: "black"
    }
  }, [_vm._v("Negro")])])])])]), _vm._v(" "), _c("div", {
    staticClass: "col-lg-12 col-md-6 col-sm-12",
    staticStyle: {
      display: "flex",
      "align-items": "center",
    ...
    staticClass: "col-md p-4"
  }, [_vm.horario.nivel == 1 ? _c("div", {
    staticClass: "col",
    staticStyle: {
      display: "flex",
      "align-items": "center",
    ...
    attrs: {
      options: _vm.calendarOptionsPrimaria,
      id: "horario"
    },
    scopedSlots: _vm._u([{
      key: "eventContent",
      fn: function fn(arg) {
        return [_c("b", [_vm._v(_vm._s(arg.event.title))])];
      }
    }], null, false, 2491254112)
  })], 1) : _c("div", {
    staticClass: "col",
    staticStyle: {
      display: "flex",
    ...
    attrs: {
      options: _vm.calendarOptionsSecundaria,
      id: "horario"
    },
    scopedSlots: _vm._u([{
      key: "eventContent",
...
var staticRenderFns = [function () {
  ...
  }, [_vm._v("Registrar Aula")])]), _vm._v(" "), _c("li", {
    staticClass: "nav-item d-none",
    attrs: {
      id: "li-update"
    }
...
/***/ "./resources/js/components/HorariosComponent.vue":
/*!*******************************************************!*\
  !*** ./resources/js/components/HorariosComponent.vue ***!
  \*******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _HorariosComponent_vue_vue_type_template_id_16e48b5e___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./HorariosComponent.vue?vue&type=template&id=16e48b5e& */ "./resources/js/components/HorariosComponent.vue?vue&type=template&id=16e48b5e&");
/* harmony import */ var _HorariosComponent_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./HorariosComponent.vue?vue&type=script&lang=js& */ "./resources/js/components/HorariosComponent.vue?vue&type=script&lang=js&");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  _HorariosComponent_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__["default"],
  _HorariosComponent_vue_vue_type_template_id_16e48b5e___WEBPACK_IMPORTED_MODULE_0__.render,
  _HorariosComponent_vue_vue_type_template_id_16e48b5e___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/components/HorariosComponent.vue"
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (component.exports);

/***/ }),

/***/ "./resources/js/components/HorariosComponent.vue?vue&type=script&lang=js&":
/*!********************************************************************************!*\
  !*** ./resources/js/components/HorariosComponent.vue?vue&type=script&lang=js& ***!
  \********************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_HorariosComponent_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./HorariosComponent.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/HorariosComponent.vue?vue&type=script&lang=js&");
 /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_HorariosComponent_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__["default"]); 

/***/ }),

/***/ "./resources/js/components/HorariosComponent.vue?vue&type=template&id=16e48b5e&":
/*!**************************************************************************************!*\
  !*** ./resources/js/components/HorariosComponent.vue?vue&type=template&id=16e48b5e& ***!
  \**************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "render": () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_HorariosComponent_vue_vue_type_template_id_16e48b5e___WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   "staticRenderFns": () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_HorariosComponent_vue_vue_type_template_id_16e48b5e___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_HorariosComponent_vue_vue_type_template_id_16e48b5e___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./HorariosComponent.vue?vue&type=template&id=16e48b5e& */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/HorariosComponent.vue?vue&type=template&id=16e48b5e&");
...
/* harmony import */ var _fullcalendar_core__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @fullcalendar/core */ "./node_modules/@fullcalendar/core/index.esm.js");
/* harmony import */ var _fullcalendar_core_internal__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @fullcalendar/core/internal */ "./node_modules/@fullcalendar/core/internal-common.esm.js");
/* harmony import */ var _options_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./options.js */ "./node_modules/@fullcalendar/vue/dist/options.js");
/* harmony import */ var _utils_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./utils.js */ "./node_modules/@fullcalendar/vue/dist/utils.js");
...
/* harmony import */ var _TransportContainer_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./TransportContainer.js */ "./node_modules/@fullcalendar/vue/dist/TransportContainer.js");
...
const FullCalendar = vue__WEBPACK_IMPORTED_MODULE_4__["default"].extend({
    props: {
        options: Object
    },
    data() {
    ...
    render(h) {
        ...
        for (const customRendering of this.customRenderingMap.values()) {
            ...
            h('div', { key: customRendering.id }, [
                h(_TransportContainer_js__WEBPACK_IMPORTED_MODULE_3__["default"], {
    ...
    mounted() {
        const customRenderingStore = new _fullcalendar_core_internal__WEBPACK_IMPORTED_MODULE_5__.cx();
        ...
        const calendar = new _fullcalendar_core__WEBPACK_IMPORTED_MODULE_6__.Calendar(this.$el, calendarOptions);
...
function buildWatchers() {
    ...
    for (let complexOptionName in _options_js__WEBPACK_IMPORTED_MODULE_0__.OPTION_IS_COMPLEX) {
            ...
            handler(val) {
                ...
                if (val !== undefined) {
                    ...
                    calendar.resetOptions({
                        ...
                        [complexOptionName]: (0,_utils_js__WEBPACK_IMPORTED_MODULE_1__.shallowCopy)(val)
                    }, true);
                    this.renderId++; // will queue a rerender
                }
            }
