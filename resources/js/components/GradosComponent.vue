            ...
            <div class="container-fluid">
                <div class="d-flex justify-content-between align-items-center ">
                    ...
                    <ul class="nav nav-tabs page-header-tab">
                        <li id="li-all" class="nav-item"><a id="link-all" class="nav-link active" data-toggle="tab" href="#grado-all">Ver Lista</a></li>
                        <li id="li-grid" class="nav-item d-none"><a id="link-grid" class="nav-link" data-toggle="tab" href="#grado-grill">Ver Cuadricula</a></li>
                        <li id="li-add" class="nav-item d-none"><a id="link-add" class="nav-link" data-toggle="tab" href="#grado-add">Registrar Grado</a></li>
                        <li id="li-update" class="nav-item d-none"><a id="link-update" class="nav-link" data-toggle="tab" href="#grado-update">Actualizar Grado</a></li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="container-fluid">
                <div class="tab-content">
                    <div class="tab-pane active" id="grado-all">
                        <a @click="mostrar_crear()" class="btn btn-primary mb-4" href="#">Registrar Grado</a>
                        <div class="row clearfix mt-2">
                            <div class="col-lg-3 col-md-6" v-for="(item, index) in data" :key="index">
                                <div class="card">
                                    <div class="card-body text-center">
                                        <h4><b>{{item.gra_descripcion}}</b></h4>
                                        <hr>
                                        <h6 class="m-2"><b>Nivel:</b></h6>
                                        ...
                                        <button type="button" class="btn btn-icon btn-sm btn-danger js-sweetalert" title="Eliminar" data-type="confirm" @click="eliminar_grado(item.gra_id)"><i class="fa fa-trash-o"></i></button>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <!-- <div class="tab-pane active" id="grado-all">
                        ...
                        <a @click="mostrar_crear()" class="btn btn-primary mb-4" href="#grado-add">Registrar Grado</a>
                        <div class="card row">
                            <div class="card-body col-md-12">
                                <div class="">
                                    <table id="table-grados" class="display " style="width:100%">
                                        <thead>
                                            <tr>
                                                <th>#</th>
                                                <th>DNI</th>
                                        ...
                                        <tbody>
                                            <tr v-for="(item, index) in data" :key="index">
                                                ...
                                                <button type="button" class="btn btn-icon btn-sm js-sweetalert d-none" title="Eliminar" data-type="confirm" @click="eliminar_grado(item.id,item.id_persona)"><i class="fa fa-trash-o text-danger"></i></button>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                    ...
                    <div class="tab-pane" id="grado-grid">
                        <div class="row">
