            ...
            <div class="container-fluid">
                <div class="d-flex justify-content-between align-items-center ">
                    <div class="header-action">
                        <h1 class="page-title">Asignar Grados</h1>
                    ...
                    <ul class="nav nav-tabs page-header-tab">
                        ...
                        <li id="li-add" class="nav-item d-none"><a id="link-add" class="nav-link" data-toggle="tab" href="#asignar-add">Registrar</a></li>
                        <li id="li-update" class="nav-item d-none"><a id="link-update" class="nav-link" data-toggle="tab" href="#asignar-update">Actualizar</a></li>
                    </ul>
                </div>
            </div>
        </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <select v-model="asignar.nivel"  class="form-control show-tick" @change="listar_cursos()">
                                    ...
                                    <div class="col-md-4">
                                        <select v-model="asignar.curso"  class="form-control show-tick">
                                            <option value="0" selected disabled>-- Selecciona --</option>
                                            <option value="-1" selected>Todos </option>
                                            <option v-for="n in cursos" :key="n.id" v-bind:value="n.cur_nombre">
                                                {{n.cur_nombre}}
                                            </option>
                                        </select>
                                    </div>
                                    ...
                                    <table id="table-asignar" class="display" style="width:100%;text-align: center;">
                                        <thead>
                                            <tr>
                                                ...
                                                <th></th>
                                                <th>Docente</th>
                                                <th v-for="(item, index) in grados" :key="index">
                                        ...
                                        <tbody>
                                            <tr v-for="(item, index) in data" :key="index">
                                                ...
                                                <td v-for="(g, index2) in item.grados" :key="index2">
                                                    <div v-for="(ss, index3) in item.secciones[index2]" :key="index3">
                                                        <div class="form-check" v-if="g[index3] == 1">
                                                            <input  class="" type="checkbox" id="flexCheckDefault" @click="guardando_secciones(grados[index2].gra_id,ss)" checked>
                                                            <label class="form-check-label" for="flexCheckDefault">
                                                                {{ss}}
                                                            </label>
                                                        </div>
                                                        <div class="form-check" v-else>
                                                            <input  class="" type="checkbox" id="flexCheckDefault" @click="guardando_secciones(grados[index2].gra_id,ss)">
                                                            <label class="form-check-label" for="flexCheckDefault">
                                                                {{ss}}
                                                            </label>
                                                        </div>
...
export default {
    ...
    methods: {
        async guardando_secciones(grado,seccion){
            var concatenar = grado+'>'+seccion;
            if(this.asignar.grado.includes(concatenar) == false){
                this.asignar.grado.push(concatenar);
            }else{
                this.asignar.grado = this.asignar.grado.filter((item) => item !== concatenar);
            }
        },
