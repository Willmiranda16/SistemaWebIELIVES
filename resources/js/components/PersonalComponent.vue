                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="personal-all">
                        <a @click="mostrar_crear()"
                            ...
                            class="btn btn-primary mb-4" href="#">Registrar Personal</a>
                        <div class="card row">
                                            ...
                                            <tr v-for="(item, index) in data" :key="index">
                                                ...
                                                <td>
                                                    ...
                                                    <button type="button" class="btn btn-icon btn-sm js-sweetalert"
                                                        ...
                                                        @click="eliminar_personal(item.pa_id)"><i
                                            ...
                                            <div class="row clearfix">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="d-flex justify-content-between">
                                                            ...
                                                            <div class="form-check">
                                                                <input class="form-check-input" v-model="isDisabledManual"
                                                ...
                                                <div class="col-lg-4 col-md-6 col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" v-model="persona.nombres" class="form-control"
                                                            required :disabled="!isDisabledManual">
                                                    </div>
                                                </div>
                                                <div class="col-lg-4 col-md-6 col-sm-12">
                                                    <div class="form-group">
                                                ...
                                                <div class="col-lg-3 col-md-6 col-sm-12">
                                                    ...
                                                    <select v-model="persona.departamento" class="form-control show-tick"
                                                        required @change="listar_provincias()">
                                                ...
                                                <div class="col-lg-3 col-md-6 col-sm-12">
                                                    ...
                                                    <select v-model="persona.provincia" class="form-control show-tick"
                                                        required @change="listar_distritos()">
                                                        <option value="0" selected disabled>-- Selecciona --</option>
                                        ...
                                        <div class="card-body">
                                            <div class="row clearfix">
                                                <div class="col-lg-6 col-md-6 col-sm-12">
                                                    ...
                                                    <select v-model="personalAcademico.niv_id"
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="usuario" name="usuario" type="text"
                                                            v-model="personalAcademico.turno" class="form-control"
                                                            aria-invalid="true" autofocus required>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6 col-md-6 col-sm-12">
                                                    <label>Rol <span class="text-danger">*</span></label>
                                                    <select v-model="personalAcademico.rol_id"
                                                        class="form-control show-tick" required>
                                                        <option value="0" selected disabled>-- Selecciona --</option>
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="text" name="text" type="text"
                                                            v-model="personalAcademico.condicion_laboral"
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="text" name="text" type="text"
                                                            v-model="personalAcademico.especialidad" class="form-control"
                                                            aria-invalid="true" autofocus required>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6 col-md-6 col-sm-12">
                                                    <label>Tutor <span class="text-danger">*</span></label>
                                                    <select v-model="personalAcademico.is_tutor"
                                                        class="form-control show-tick" required>
                                                        <option value="0" disabled>-- Selecciona --</option>
                                            ...
                                            <div class="row clearfix">
                                                <div class="col-lg-4 col-md-6 col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group mb-3">
                                                            <input type="number" v-model="personal_update.dni"
                                                ...
                                                <div class="col-lg-4 col-md-6 col-sm-12">
                                                    <div class="form-group">
                                                        <label>Nombres <span class="text-danger">*</span></label>
                                                        <input type="text" v-model="personal_update.nombres"
                                                ...
                                                <div class="col-lg-4 col-md-6 col-sm-12">
                                                    <div class="form-group">
                                                        <label>Apellidos <span class="text-danger">*</span></label>
                                                        <input type="text" v-model="personal_update.apellidos"
                                                            class="form-control" required disabled>
                                                    </div>
                                                </div>
                                                <div class="col-lg-4 col-md-6 col-sm-12">
                                                    <label>Sexo <span class="text-danger">*</span></label>
                                                    <select v-model="personal_update.sexo" class="form-control show-tick"
                                                        required disabled>
                                                        <option value="0" disabled>-- Selecciona --</option>
                                                        <option value="M">Masculino</option>
                                                        <option value="F">Femenino</option>
                                                ...
                                                <div class="col-lg-4 col-md-6 col-sm-12">
                                                    <div class="form-group">
                                                        <label>Fecha de Nacimiento </label>
                                                        <input type="date" v-model="personal_update.fecha_nacimiento"
                                                            class="form-control">
                                                    </div>
                                                </div>
                                                <div class="col-lg-4 col-md-6 col-sm-12">
                                                    <label>Estado Civil </label>
                                                    <select v-model="personal_update.estado_civil"
                                                ...
                                                <div class="col-lg-3 col-md-6 col-sm-12">
                                                    <div class="form-group">
                                                        <label>País <span class="text-danger">*</span></label>
                                                        <input type="text" v-model="personal_update.pais"
                                                            class="form-control" required disabled>
                                                    </div>
                                                </div>
                                                <div class="col-lg-3 col-md-6 col-sm-12">
                                                    <label>Departamento <span class="text-danger">*</span></label>
                                                    <select v-model="personal_update.departamento"
                                                        class="form-control show-tick" required
                                                ...
                                                <div class="col-lg-3 col-md-6 col-sm-12">
                                                    <label>Provincia <span class="text-danger">*</span></label>
                                                    <select v-model="personal_update.provincia"
                                                        class="form-control show-tick" required
                                                ...
                                                <div class="col-lg-3 col-md-6 col-sm-12">
                                                    <label>Distrito <span class="text-danger">*</span></label>
                                                    <select v-model="personal_update.distrito"
                                                        class="form-control show-tick" required>
                                                        <option value="0" selected disabled>-- Selecciona --</option>
                                                        <option v-for="d in distritos" :key="d.id" v-bind:value="d.idDist">
                                                            {{ d.distrito }}
                                                ...
                                                <div class="col-lg-4 col-md-6 col-sm-12">
                                                    <div class="form-group">
                                                        <label>Dirección </label>
                                                        <input type="text" v-model="personal_update.direccion"
                                                            class="form-control">
                                                    </div>
                                                </div>
                                                <div class="col-lg-4 col-md-6 col-sm-12">
                                                    <div class="form-group">
                                                        <label>Celular</label>
                                                        <input type="number" v-model="personal_update.celular"
                                                ...
                                                <div class="col-lg-4 col-md-6 col-sm-12">
                                                    <div class="form-group">
                                                        <label>Correo </label>
                                                        <input type="email" v-model="personal_update.email"
                                                            class="form-control">
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="row clearfix">
                                                <div class="col-lg-6 col-md-6 col-sm-12">
                                                    <label>Nivel <span class="text-danger">*</span></label>
                                                    <select v-model="personal_update.niv_id" class="form-control show-tick"
                                                        required>
                                                        <option value="0" selected disabled>-- Selecciona --</option>
                                                        <option v-for="r in niveles" :key="r.id" v-bind:value="r.niv_id">
                                                            {{ r.niv_descripcion }}
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-12">
                                                    <div class="form-group">
                                                        <label>Turno <span class="text-danger">*</span></label>
                                                        <input id="usuario" name="usuario" type="text"
                                                            v-model="personal_update.turno" class="form-control"
                                                            aria-invalid="true" autofocus required>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6 col-md-6 col-sm-12">
                                                    <label>Rol <span class="text-danger">*</span></label>
                                                    <select v-model="personal_update.rol_id" class="form-control show-tick"
                                                        required>
                                                        <option value="0" selected disabled>-- Selecciona --</option>
                                                        <option v-for="r in roles" :key="r.id" v-bind:value="r.rol_id">
                                                            {{ r.rol_descripcion }}
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-12">
                                                    <div class="form-group">
                                                        <label>Condición Laboral <span class="text-danger">*</span></label>
                                                        <input id="text" name="text" type="text"
                                                            v-model="personal_update.condicion_laboral" class="form-control"
                                                            aria-invalid="true" autofocus required>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6 col-md-6 col-sm-12">
                                                    <div class="form-group">
                                                        <label>Especialidad <span class="text-danger">*</span></label>
                                                        <input id="text" name="text" type="text"
                                                            v-model="personal_update.especialidad" class="form-control"
                                                            aria-invalid="true" autofocus required>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6 col-md-6 col-sm-12">
                                                    <label>Tutor <span class="text-danger">*</span></label>
                                                    <select v-model="personal_update.is_tutor"
                                                        class="form-control show-tick" required>
                                                        <option value="0" disabled>-- Selecciona --</option>
                                                        <option value="1">SI</option>
                                                        <option value="2">NO</option>
