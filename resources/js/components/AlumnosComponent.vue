            ...
            <div class="container-fluid">
                <div class="d-flex justify-content-between align-items-center ">
                    ...
                    <ul class="nav nav-tabs page-header-tab">
                        <li id="li-all-alumno" class="nav-item"><a id="link-all-alumno" class="nav-link active"
                                data-toggle="tab" href="#">Ver Lista</a></li>
                        <li id="li-grid-alumno" class="nav-item d-none"><a id="link-grid-alumno" class="nav-link"
                                data-toggle="tab" href="#">Ver Cuadricula</a></li>
                        <li id="li-add-alumno" class="nav-item d-none"><a id="link-add-alumno" class="nav-link"
                                data-toggle="tab" href="#">Registrar Alumno</a></li>
                        <li id="li-add-apoderado" class="nav-item d-none"><a id="link-add-apoderado" class="nav-link"
                                data-toggle="tab" href="#">Crear Apoderado</a></li>
                        <li id="li-update-alumno" class="nav-item d-none"><a id="link-update-alumno" class="nav-link"
                                data-toggle="tab" href="#">Actualizar Alumno</a></li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="container-fluid">
                <div class="tab-content">
                    <div class="tab-pane active" id="alumno-all">
                        ...
                        <a @click="mostrar_crear()"
                            style="background: rgb(0,147,221);background: linear-gradient(180deg, rgba(0,147,221,1) 0%, rgba(115,162,235,1) 100%);"
                            class="btn btn-primary mb-4" href="#">Registrar Alumno</a>
                        <div class="card row">
                                        ...
                                        <tbody>
                                            <tr v-for="(item, index) in data" :key="index">
                                                ...
                                                <td>
                                                    ...
                                                    <span v-else-if="item.alu_estado == 2"
                                                        class="tag tag-orange">Inactivo</span>
                                                    <span v-else class="tag tag-danger">Retirado</span>
                                                </td>
                                                <td>
                                                    <button type="button" class="btn btn-icon btn-sm d-none" title="View"><i
                                                            class="fa fa-eye"></i></button>
                                                    <button type="button" class="btn btn-icon btn-sm" title="Editar"
                                                        @click="mostrar_actualizar(item)"><i
                                                            class="fa fa-edit"></i></button>
                                                    <button type="button" class="btn btn-icon btn-sm js-sweetalert"
                                                        title="Eliminar" data-type="confirm"
                                                        @click="eliminar_alumno(item.alu_id, item.per_id, item.apo_id, item.apo_per_id)"><i
                        ...
                        <div class="row">
                            <div class="col-xl-4 col-md-12">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <p>Hello I am Celena Anderson a Clerk in Xyz College USA. I love to work with all my
                                            college staff and seniour professors.</p>
                                        <ul class="list-group">
                                            ...
                                            <li class="list-group-item">
                                                ...
                                                <div class="progress progress-xxs">
                                                    <div class="progress-bar bg-blue" role="progressbar" style="width: 72%"
                                                ...
                                                <div class="collapse p-4 section-gray mt-2" id="collapseExample1">
                                                    ...
                                                    <ul class="recent_comments list-unstyled mt-4 mb-0">
                                                        ...
                                                        <li>
                                                            ...
                                                            <div class="comment_body">
                                                                <h6>Dessie Parks <small class="float-right font-14">1min
                                                                        ago</small></h6>
                                            ...
                                            <div class="row clearfix">
                                                <div class="col-lg-4 col-md-6 col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group mb-3">
                                                            <input type="number" v-model="persona.dni" class="form-control"
                                                                minlength="8" maxlength="8" required>
                                                            <div class="input-group-append">
                                                                <button v-if="!loadingDni" @click="buscando_dni()"
                                                                    class="btn btn-primary" type="button">
                                                                    <i class="fa-solid fa-magnifying-glass"></i>
                                                                    Buscar
                                                                </button>
                                                                <button v-else id="btnfollow_recargar"
                                                                    class="btn btn-primary" type="button">
                                                ...
                                                <div class="col-lg-4 col-md-6 col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" v-model="persona.nombres" class="form-control"
                                                            required :disabled="!enableStudentField">
                                                    </div>
                                                </div>
                                                <div class="col-lg-4 col-md-6 col-sm-12">
                                                    <div class="form-group">
                                                ...
                                                <div class="col-lg-3 col-md-6 col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" v-model="persona.pais" class="form-control"
                                                            required :disabled="!enableStudentField">
                                                    </div>
                                                </div>
                                                <div class="col-lg-3 col-md-6 col-sm-12">
                                                    <label>Departamento </label>
                                                    <select v-model="persona.departamento" class="form-control show-tick"
                                                        @change="listar_provincias()">
                                                        <option value="0" selected disabled>-- Selecciona --</option>
                                                        <option v-for="d in departamentos" :key="d.id"
                                                            v-bind:value="d.idDepa">
                                                            {{ d.departamento }}
                                                        </option>
                                                    </select>
                                                </div>
                                                <div class="col-lg-3 col-md-6 col-sm-12">
                                                    ...
                                                    <select v-model="persona.provincia" class="form-control show-tick"
                                                        @change="listar_distritos()">
                                                        <option value="0" selected disabled>-- Selecciona --</option>
                                                ...
                                                <div class="col-lg-4 col-md-6 col-sm-12">
                                                    <div class="form-group">
                                                        <label>Celular</label>
                                                        <input type="number" v-model="persona.celular" class="form-control"
                                            ...
                                            <div class="row clearfix">
                                                <div class="col-lg-4 col-md-6 col-sm-12">
                                                    <div class="form-group">
                                                        <div class="d-flex justify-content-between">
                                                            ...
                                                            <div class="form-check">
                                                                <input class="form-check-input"
                                                                    v-model="enableGuardianField" type="checkbox" value=""
                                                        ...
                                                        <div class="input-group mb-3">
                                                            <input type="number" v-model="apoderado.dni"
                                                                class="form-control" minlength="8" maxlength="8">
                                                            <div class="input-group-append">
                                                                <button v-if="!loadingDni2" @click="buscando_dni_apo()"
                                                                    class="btn btn-primary" type="button">
                                                                    <i class="fa-solid fa-magnifying-glass"></i>
                                                                    Buscar
                                                                </button>
                                                ...
                                                <div class="col-lg-4 col-md-6 col-sm-12">
                                                    <div class="form-group">
                                                        <label>Nombres <span class="text-danger">*</span></label>
                                                        <input type="text" v-model="apoderado.nombres" class="form-control"
                                                            :disabled="!enableGuardianField">
                                                    </div>
                                                </div>
                                                <div class="col-lg-4 col-md-6 col-sm-12">
                                                    <div class="form-group">
                                                        <label>Apellidos <span class="text-danger">*</span></label>
                                                        <input type="text" v-model="apoderado.apellidos"
                                                            class="form-control" :disabled="!enableGuardianField">
                                                    </div>
                                                </div>
                                                <div class="col-lg-4 col-md-6 col-sm-12">
                                                    <label>Sexo <span class="text-danger">*</span></label>
                                                    <select v-model="apoderado.sexo" class="form-control show-tick">
                                                        <option value="0" disabled>-- Selecciona --</option>
                                                        <option value="M">Masculino</option>
                                                        <option value="F">Femenino</option>
                                                    </select>
                                                ...
                                                <div class="col-lg-4 col-md-6 col-sm-12">
                                                    <div class="form-group">
                                                        <label>Fecha de Nacimiento </label>
                                                        <input type="date" v-model="apoderado.fecha_nacimiento"
                                                            class="form-control">
                                                    </div>
                                                </div>
                                                <div class="col-lg-4 col-md-6 col-sm-12">
                                                ...
                                                <div class="col-lg-3 col-md-6 col-sm-12">
                                                    <div class="form-group">
                                                        <label>País <span class="text-danger">*</span></label>
                                                        <input type="text" v-model="apoderado.pais" class="form-control"
                                                            required :disabled="!enableGuardianField">
                                                    </div>
                                                </div>
                                                <div class="col-lg-3 col-md-6 col-sm-12">
                                                    <label>Departamento </label>
                                                    <select v-model="apoderado.departamento" class="form-control show-tick"
                                                        @change="listar_provincias_apo()">
                                                        <option value="0" selected disabled>-- Selecciona --</option>
                                                        <option v-for="d in departamentos" :key="d.id"
                                                            v-bind:value="d.idDepa">
                                                            {{ d.departamento }}
                                                ...
                                                <div class="col-lg-3 col-md-6 col-sm-12">
                                                    <label>Provincia </label>
                                                    <select v-model="apoderado.provincia" class="form-control show-tick"
                                                        @change="listar_distritos_apo()">
                                                        <option value="0" selected disabled>-- Selecciona --</option>
                                                        <option v-for="p in provincias_apo" :key="p.id"
                                                            v-bind:value="p.idProv">
                                                            {{ p.provincia }}
                                                        </option>
                                                    </select>
                                                </div>
                                                <div class="col-lg-3 col-md-6 col-sm-12">
                                                    ...
                                                    <select v-model="apoderado.distrito" class="form-control show-tick">
                                                        <option value="0" selected disabled>-- Selecciona --</option>
                                                        <option v-for="d in distritos_apo" :key="d.id"
                                                            v-bind:value="d.idDist">
                                                            {{ d.distrito }}
                                                        </option>
                                                    </select>
                                                </div>
                                                <div class="col-lg-4 col-md-6 col-sm-12">
                                                    <div class="form-group">
                                                        <label>Dirección </label>
                                                        <input type="text" v-model="apoderado.direccion"
                                                            class="form-control">
                                                    </div>
                                                </div>
                                                <div class="col-lg-4 col-md-6 col-sm-12">
                                                    <div class="form-group">
                                                        <label>Celular</label>
                                                        <input type="number" v-model="apoderado.celular"
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-12">
                                                    ...
                                                    <select v-model="apoderado.parentesco" class="form-control show-tick">
                                                        <option value="0" disabled>-- Selecciona --</option>
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        <select v-model="apoderado.vive_con_estudiante"
                                                ...
                                                <div class="col-sm-12 text-right mt-4">
                                                    ...
                                                    <button v-else disabled type="button"
                                                        class="btn btn-primary">Procesando...</button>
                                            ...
                                            <div class="row clearfix">
                                                <div class="col-lg-4 col-md-6 col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group mb-3">
                                                            <input type="number" v-model="update_data.dni"
                                                ...
                                                <div class="col-lg-4 col-md-6 col-sm-12">
                                                    <div class="form-group">
                                                        <label>Nombres <span class="text-danger">*</span></label>
                                                        <input type="text" v-model="update_data.nombres"
                                                ...
                                                <div class="col-lg-4 col-md-6 col-sm-12">
                                                    <div class="form-group">
                                                        <label>Apellidos <span class="text-danger">*</span></label>
                                                        <input type="text" v-model="update_data.apellidos"
                                                            class="form-control" required disabled>
                                                    </div>
                                                </div>
                                                <div class="col-lg-4 col-md-6 col-sm-12">
                                                    <label>Sexo <span class="text-danger">*</span></label>
                                                    <select v-model="update_data.sexo" class="form-control show-tick"
                                                        required>
                                                        <option value="0" disabled>-- Selecciona --</option>
                                                        <option value="M">Masculino</option>
                                                        <option value="F">Femenino</option>
                                                ...
                                                <div class="col-lg-4 col-md-6 col-sm-12">
                                                    <div class="form-group">
                                                        <label>Fecha de Nacimiento </label>
                                                        <input type="date" v-model="update_data.fecha_nacimiento"
                                                            class="form-control">
                                                    </div>
                                                </div>
                                                <div class="col-lg-4 col-md-6 col-sm-12">
                                                    <label>Estado Civil </label>
                                                    <select v-model="update_data.estado_civil"
                                                        class="form-control show-tick">
                                                        <option value="0" disabled>-- Selecciona --</option>
                                                        <option value="S">Soltero</option>
                                                        <option value="C">Casado</option>
                                                ...
                                                <div class="col-lg-3 col-md-6 col-sm-12">
                                                    <div class="form-group">
                                                        <label>País <span class="text-danger">*</span></label>
                                                        <input type="text" v-model="update_data.pais" class="form-control"
                                                            required disabled>
                                                    </div>
                                                </div>
                                                <div class="col-lg-3 col-md-6 col-sm-12">
                                                    <label>Departamento </label>
                                                    <select v-model="update_data.departamento"
                                                        class="form-control show-tick" @change="listar_provincias2()">
                                                        <option value="0" selected disabled>-- Selecciona --</option>
                                                        <option v-for="d in departamentos" :key="d.id"
                                                            v-bind:value="d.idDepa">
                                                            {{ d.departamento }}
                                                ...
                                                <div class="col-lg-3 col-md-6 col-sm-12">
                                                    <label>Provincia </label>
                                                    <select v-model="update_data.provincia" class="form-control show-tick"
                                                        @change="listar_distritos2()">
                                                        <option value="0" selected disabled>-- Selecciona --</option>
                                                        <option v-for="p in provincias2" :key="p.id"
                                                            v-bind:value="p.idProv">
                                                            {{ p.provincia }}
                                                        </option>
                                                    </select>
                                                ...
                                                <div class="col-lg-4 col-md-6 col-sm-12">
                                                    <div class="form-group">
                                                        <label>Dirección </label>
                                                        <input type="text" v-model="update_data.direccion"
                                                            class="form-control">
                                                    </div>
                                                </div>
                                                <div class="col-lg-4 col-md-6 col-sm-12">
                                                    <div class="form-group">
                                                        <label>Celular</label>
                                                        <input type="number" v-model="update_data.celular"
                                                            class="form-control" minlength="9" maxlength="9">
                                                    </div>
                                                </div>
                                                <div class="col-lg-4 col-md-6 col-sm-12">
                                                    <div class="form-group">
                                                        <label>Correo </label>
                                                        <input type="email" v-model="update_data.email"
                                                            class="form-control">
                                                    </div>
                                                </div>
                                                <div class="col-lg-6 col-md-6 col-sm-12">
                                                    <div class="form-group">
                                                        <label>Estado</label>
                                                        <select v-model="update_data.alu_estado"
                                                            class="form-control show-tick">
                                                            <option value="0" disabled>-- Selecciona --</option>
                                            ...
                                            <div class="row clearfix">
                                                <div class="col-lg-4 col-md-6 col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group mb-3">
                                                            <input type="number" v-model="update_data.apo_dni"
                                                                class="form-control" minlength="8" maxlength="8">
                                                            <div class="input-group-append d-none">
                                                                <button v-if="!loadingDni2" @click="buscando_dni_apo()"
                                                                    class="btn btn-primary" type="button">
                                                ...
                                                <div class="col-lg-4 col-md-6 col-sm-12">
                                                    <div class="form-group">
                                                        <label>Nombres <span class="text-danger">*</span></label>
                                                        <input type="text" v-model="update_data.apo_nombres"
                                                            class="form-control">
                                                    </div>
                                                </div>
                                                <div class="col-lg-4 col-md-6 col-sm-12">
                                                    <div class="form-group">
                                                        <label>Apellidos <span class="text-danger">*</span></label>
                                                        <input type="text" v-model="update_data.apo_apellidos"
                                                            class="form-control">
                                                    </div>
                                                </div>
                                                <div class="col-lg-4 col-md-6 col-sm-12">
                                                    <label>Sexo <span class="text-danger">*</span></label>
                                                    <select v-model="update_data.apo_sexo" class="form-control show-tick"
                                                        required>
                                                        <option value="0" disabled>-- Selecciona --</option>
                                                        <option value="M">Masculino</option>
                                                        <option value="F">Femenino</option>
                                                ...
                                                <div class="col-lg-4 col-md-6 col-sm-12">
                                                    <div class="form-group">
                                                        <label>Fecha de Nacimiento </label>
                                                        <input type="date" v-model="update_data.apo_fecha_nacimiento"
                                                            class="form-control">
                                                    </div>
                                                </div>
                                                <div class="col-lg-4 col-md-6 col-sm-12">
                                                    <label>Estado Civil </label>
                                                    <select v-model="update_data.apo_estado_civil"
                                                        class="form-control show-tick">
                                                        <option value="0" disabled>-- Selecciona --</option>
                                                        <option value="S">Soltero</option>
                                                        <option value="C">Casado</option>
                                                ...
                                                <div class="col-lg-3 col-md-6 col-sm-12">
                                                    <div class="form-group">
                                                        <label>País <span class="text-danger">*</span></label>
                                                        <input type="text" v-model="update_data.apo_pais"
                                                            class="form-control">
                                                    </div>
                                                </div>
                                                <div class="col-lg-3 col-md-6 col-sm-12">
                                                    <label>Departamento </label>
                                                    <select v-model="update_data.apo_departamento"
                                                        class="form-control show-tick" @change="listar_provincias_apo2()">
                                                        <option value="0" selected disabled>-- Selecciona --</option>
                                                        <option v-for="d in departamentos" :key="d.id"
                                                            v-bind:value="d.idDepa">
                                                            {{ d.departamento }}
                                                ...
                                                <div class="col-lg-3 col-md-6 col-sm-12">
                                                    <label>Provincia </label>
                                                    <select v-model="update_data.apo_provincia"
                                                        class="form-control show-tick" @change="listar_distritos_apo2()">
                                                        <option value="0" selected disabled>-- Selecciona --</option>
                                                        <option v-for="p in provincias_apo2" :key="p.id"
                                                            v-bind:value="p.idProv">
                                                            {{ p.provincia }}
                                                        </option>
                                                    </select>
                                                ...
                                                <div class="col-lg-3 col-md-6 col-sm-12">
                                                    <label>Distrito </label>
                                                    <select v-model="update_data.apo_distrito"
                                                        class="form-control show-tick">
                                                        <option value="0" selected disabled>-- Selecciona --</option>
                                                        <option v-for="d in distritos_apo2" :key="d.id"
                                                            v-bind:value="d.idDist">
                                                            {{ d.distrito }}
                                                        </option>
                                                    </select>
                                                ...
                                                <div class="col-lg-4 col-md-6 col-sm-12">
                                                    <div class="form-group">
                                                        <label>Dirección </label>
                                                        <input type="text" v-model="update_data.apo_direccion"
                                                            class="form-control">
                                                    </div>
                                                </div>
                                                <div class="col-lg-4 col-md-6 col-sm-12">
                                                    <div class="form-group">
                                                        <label>Celular</label>
                                                        <input type="number" v-model="update_data.apo_celular"
                                                            class="form-control" minlength="9" maxlength="9">
                                                    </div>
                                                </div>
                                                <div class="col-lg-4 col-md-6 col-sm-12">
                                                    <div class="form-group">
                                                        <label>Correo </label>
                                                        <input type="email" v-model="update_data.apo_email"
                                                            class="form-control">
                                                    </div>
                                                </div>
                                                <div class="col-lg-6 col-md-6 col-sm-12">
                                                    <label>Parentesco <span class="text-danger">*</span></label>
                                                    <select v-model="update_data.apo_parentesco"
                                                        class="form-control show-tick">
                                                        <option value="0" disabled>-- Selecciona --</option>
                                                        <option value="Padre">Padre</option>
                                                        <option value="Madre">Madre</option>
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-12">
                                                    <div class="form-group">
                                                        <label>Vive con el estudiante</label>
                                                        <select v-model="update_data.apo_vive_con_estudiante"
                                                            class="form-control show-tick">
                                                            <option value="0" disabled>-- Selecciona --</option>
                                                            <option value="1">SI</option>
                                                            <option value="2">NO</option>
                                                ...
                                                <div class="col-sm-12 text-right mt-4">
                                                    ...
                                                    <!-- <button type="submit" class="btn btn-primary">Registrar</button> -->
                                                    <button type="button" class="btn btn-outline-secondary"
                                                        @click="cancelar2()">Cancelar</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
