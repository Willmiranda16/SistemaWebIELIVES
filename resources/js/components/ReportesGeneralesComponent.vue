                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row mb-4">
                                    ...
                                    <div class="col-md-3">
                                        <select v-model="data.año" @change="listar_niveles()"
                                    ...
                                    <div class="col-md-3">
                                        <select v-model="data.nivel" class="form-control show-tick"
                                    ...
                                    <div class="col-lg-2 col-md-4 col-sm-6" style="display: flex;align-items: center;">
                                        <a v-if="!loading0" @click="buscar_data()" href="javascript:void(0);"
                                            class="btn btn-sm btn-primary btn-block" title="">Cargar</a>
                                ...
                                <div class="row d-none">
                                    ...
                                    <div class="col-md-3">
                                        <select v-model="data.grado" class="form-control show-tick"
