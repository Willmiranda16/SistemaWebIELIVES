            ...
            <div class="container-fluid">
                <div class="d-flex justify-content-between align-items-center ">
                    ...
                    <ul class="nav nav-tabs page-header-tab">
                        <li id="li-all" class="nav-item"><a id="link-all" class="nav-link active" data-toggle="tab" href="#seccion-all">Ver Lista</a></li>
                        <li id="li-grid" class="nav-item d-none"><a id="link-grid" class="nav-link" data-toggle="tab" href="#seccion-grill">Ver Cuadricula</a></li>
                        <li id="li-add" class="nav-item d-none"><a id="link-add" class="nav-link" data-toggle="tab" href="#seccion-add">Registrar Sección</a></li>
                        <li id="li-update" class="nav-item d-none"><a id="link-update" class="nav-link" data-toggle="tab" href="#seccion-update">Actualizar Sección</a></li>
                    </ul>
                </div>
            </div>
        </div>
        <div class="section-body mt-4">
            <div class="container-fluid">
                <div class="tab-content">
                    <div class="tab-pane active" id="seccion-all">
                        <a @click="mostrar_crear()" class="btn btn-primary mb-4" href="#">Registrar Sección</a>
                            ...
                            <div class="col-lg-3 col-md-6" v-for="(item, index) in data" :key="index">
                                <div class="card">
                                    <div class="card-body text-center">
                                        ...
                                        <button type="button" class="btn btn-icon btn-sm btn-danger js-sweetalert" title="Eliminar" data-type="confirm" @click="eliminar_seccion(item.sec_id)"><i class="fa fa-trash-o"></i></button>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <tbody>
                                    <tr v-for="(item, index) in data" :key="index">
                                        ...
                                        <td>
                                            ...
                                            <button type="button" class="btn btn-icon btn-sm btn-success" title="Editar" @click="mostrar_actualizar(item)"><i class="fa fa-edit"></i></button>
                                            <button type="button" class="btn btn-icon btn-sm btn-danger js-sweetalert" title="Eliminar" data-type="confirm" @click="eliminar_seccion(item.gra_id)"><i class="fa fa-trash-o"></i></button>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                    ...
                    <!-- <div class="tab-pane active" id="seccion-all">
                        ...
                        <a @click="mostrar_crear()" class="btn btn-primary mb-4" href="#seccion-add">Registrar seccion</a>
                        <div class="card row">
                            <div class="card-body col-md-12">
                                <div class="">
                                    <table id="table-seccions" class="display " style="width:100%">
                                        <thead>
                                            <tr>
                                                <th>#</th>
                                                <th>DNI</th>
                                        ...
                                        <tbody>
                                            <tr v-for="(item, index) in data" :key="index">
                                                ...
                                                <button type="button" class="btn btn-icon btn-sm js-sweetalert d-none" title="Eliminar" data-type="confirm" @click="eliminar_seccion(item.id,item.id_persona)"><i class="fa fa-trash-o text-danger"></i></button>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                    ...
                    <div class="tab-pane" id="seccion-grid">
                        <div class="row">
                        ...
                        <div class="card">
                            <form class="card-body" @submit.prevent="agregar_seccion">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-7">
                                        <select v-model="seccion.gra_id"  class="form-control show-tick" required>
...
export default {
    ...
    methods: {
        ...
        async listar_secciones() {
            axios.get("/api/listar-secciones-all")
            .then(response=>{
