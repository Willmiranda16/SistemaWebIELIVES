                            ...
                            <div class="col-lg-3 col-md-6" v-for="(item, index) in data" :key="index">
                                <div class="card">
                                    <div class="card-body text-center">
                                        ...
                                        <span class="tag tag-blue" v-if="item.nivel == 'Primaria'">{{ item.grado }} de
                                            {{ item.nivel }}</span>
                                        ...
                                        <button type="button" class="btn btn-icon btn-sm btn-success" title="Editar"
                                            @click="mostrar_actualizar(item)"><i class="fa fa-edit"></i></button>
                                        <button type="button" class="btn btn-icon btn-sm btn-danger js-sweetalert"
                                            title="Eliminar" data-type="confirm" @click="eliminar_aula(item.sec_id)"><i
                        ...
                        <div class="card">
                            <form class="card-body" @submit.prevent="agregar_aula">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-7">
                                        <input type="text" placeholder="aula 1, aula 2, aula 3 ..." class="form-control"
                                            v-model="aula.descripcion" autofocus required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-3 col-form-label">Nro Vacantes <span
                                            class="text-danger">*</span></label>
                                    <div class="col-md-7">
                                        <input type="number" placeholder="0" class="form-control" v-model="aula.vacantes"
                                            autofocus required>
                                    </div>
                                </div>
                                <div class="form-group row">
                        ...
                        <div class="card">
                            <form class="card-body" @submit.prevent="actualizar_aula">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-7">
                                        <input type="text" placeholder="aula 1, aula 2, aula 3 ..." class="form-control"
                                            v-model="aula_update.descripcion" autofocus required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-3 col-form-label">Nro Vacantes <span
                                    ...
                                    <div class="col-md-7">
                                        <input type="number" placeholder="0" class="form-control"
                                            v-model="aula_update.vacantes" autofocus required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-3 col-form-label">Grado <span class="text-danger">*</span></label>
