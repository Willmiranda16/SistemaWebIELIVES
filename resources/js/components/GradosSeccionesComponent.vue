<template>
    <div>
                ...
                <div class="d-flex justify-content-between align-items-center ">
                    ...
                    <ul class="nav nav-tabs page-header-tab">
                        ...
                        <li id="li-grid" class="nav-item d-none"><a id="link-grid" class="nav-link" data-toggle="tab"
                                href="#">Ver Cuadricula</a></li>
                        <li id="li-add" class="nav-item d-none"><a id="link-add" class="nav-link" data-toggle="tab"
                                href="#">Registrar Grado</a></li>
                        <li id="li-update" class="nav-item d-none"><a id="link-update" class="nav-link" data-toggle="tab"
                                href="#">Actualizar Grado</a></li>

                        <li id="li-add-seccion" class="nav-item d-none"><a id="link-add-seccion" class="nav-link"
                                data-toggle="tab" href="#">Registrar Sección</a></li>
                        <li id="li-update-seccion" class="nav-item d-none"><a id="link-update-seccion" class="nav-link"
                                data-toggle="tab" href="#">Actualizar Sección</a></li>
                    </ul>
                </div>
            </div>
        </div>
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="grado-all">
                        <a @click="mostrar_crear()"
                            ...
                            class="btn btn-primary mb-4" href="#">Registrar Grado</a>
                        <div class="card row">
                                    ...
                                    <table id="table-grados-secciones" class="display " style="width:100%">
                                        ...
                                        <tbody>
                                            <tr v-for="(item, index) in data" :key="index">
                                                ...
                                                <td>
                                                    <button type="button" class="btn btn-icon btn-sm" title="Ver Secciones"
                                                        data-toggle="modal" data-target=".bd-secciones-modal"
                                                        @click="listar_secciones(item, item.nivel, item.gra_descripcion)"><i
                                                            class="fa fa-eye text-secondary"></i></button>
                                                    {{ item.secciones }}
                                                </td>
                                                <td>
                                                    <button type="button" class="btn btn-icon btn-sm" title="Ver cursos"
                                                        data-toggle="modal" data-target=".bd-cursos-modal"
                                                        @click="listar_cursos(item, item.nivel, item.gra_descripcion)"><i
                                                            class="fa-solid fa-list text-secondary"></i></button>
                                                    {{ item.cursos }}
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <button type="button" class="btn btn-icon btn-sm"
                                                        ...
                                                        @click="mostrar_crear_seccion(item.gra_id)"><i
                                                            class="fa-solid fa-plus text-primary"></i></button>
                                                    <button type="button" class="btn btn-icon btn-sm" title="Editar Grado"
                                                        @click="mostrar_actualizar(item)"><i
                                                            class="fa fa-edit text-warning"></i></button>
                                                    <button type="button" class="btn btn-icon btn-sm js-sweetalert d-none"
                                                        title="Eliminar Grado" data-type="confirm"
                                                        @click="eliminar_grado(item.gra_id)"><i
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-7">
                                        <input type="text" class="form-control" placeholder="Grado 1, Grado 2, Grado 3 ..."
                                            v-model="grado.descripcion" autofocus required>
                                    </div>
                                </div>
                                <div class="form-group row">
                            ...
                            <form class="card-body" @submit.prevent="actualizar_grado">
                                <div class="form-group row">
                                    <label class="col-md-3 col-form-label">Descripción <span
                                            class="text-danger">*</span></label>
                                    <div class="col-md-7">
                                        <input type="text" class="form-control" v-model="grado_update.descripcion" autofocus
                                            required>
                                    </div>
                                </div>
                                <div class="form-group row">
                    ...
                    <div class="tab-pane" id="seccion-add">
                        <div class="card">
                            <form class="card-body" @submit.prevent="agregar_seccion">
                                <div class="form-group row">
                                    <label class="col-md-3 col-form-label">Periodo <span
                                            class="text-danger">*</span></label>
                                    <div class="col-md-7">
                                        <select v-model="seccion.periodo" class="form-control show-tick" required>
                                            <option value="0" selected disabled>-- Selecciona --</option>
                                            <option v-for="p in periodos" :key="p.id" :value="p.per_id">
                                                {{ p.periodo }}
                                            </option>
                                        </select>
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-7">
                                        <input type="text" placeholder="Seccion 1, Seccion 2, Seccion 3 ..."
                                            class="form-control" v-model="seccion.descripcion" autofocus required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-7">
                                        <select v-model="seccion.gra_id" class="form-control show-tick" required disabled>
                                            <option value="0" selected disabled>-- Selecciona --</option>
                                            <option v-for="g in grados" :key="g.id" :value="g.gra_id">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-7">
                                        <select v-model="seccion.tutor" class="form-control show-tick">
                                            <option value="0" selected disabled>-- Selecciona --</option>
                                            <option v-for="t in tutores" :key="t.id" :value="t.pa_id">
                                ...
                                <div class="form-group row">
                                    <label class="col-md-3 col-form-label">Nro Vacantes <span
                                            class="text-danger">*</span></label>
                                    <div class="col-md-7">
                                        <input type="number" placeholder="0" class="form-control" v-model="seccion.vacantes"
                                            autofocus required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-7 text-right mt-4">
                                        ...
                                        <!-- <button type="submit" class="btn btn-primary">Registrar</button> -->
                                        <button type="button" class="btn btn-outline-secondary"
                                            @click="cancelar_seccion()">Cancelar</button>
                                    </div>
                                </div>
                            </form>
                        </div>
                        ...
                        <div class="card">
                            <form class="card-body" @submit.prevent="actualizar_seccion">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-7">
                                        <input type="text" placeholder="Seccion 1, Seccion 2, Seccion 3 ..."
                                            class="form-control" v-model="seccion_update.descripcion" autofocus required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-3 col-form-label">Nro Vacantes <span
                                    ...
                                    <div class="col-md-7">
                                        <input type="number" placeholder="0" class="form-control"
                                            v-model="seccion_update.vacantes" autofocus required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-3 col-form-label">Grado <span class="text-danger">*</span></label>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-7 text-right mt-4">
                                        ...
                                        <!-- <button type="submit" class="btn btn-primary">Registrar</button> -->
                                        <button type="button" class="btn btn-outline-secondary"
                                            @click="cancelar2_seccion()">Cancelar</button>
                                    </div>
                                </div>
                            </form>
                        </div>
        ...
        <div class="modal fade bd-secciones-modal" id="seccionesVer" tabindex="-1" role="dialog"
                    ...
                    <div class="modal-body">
                        <div class="row clearfix mt-2" v-if="secciones.length > 0">
                            <div class="col-lg-4 col-md-6" v-for="(item, index) in secciones" :key="index">
                                <div class="card"
                                    style="color: black;background: linear-gradient(rgb(125 183 213 / 50%) 0%, rgb(175 192 223 / 50%) 100%);">
                        ...
                        <div class="row clearfix mt-2" v-else>
                            <div class="col-lg-12 col-md-6 text-center">
                                <img src="https://img.freepik.com/vector-premium/ningun-concepto-ilustracion-datos_108061-573.jpg"
                                    alt="error" width="30%">
        ...
        <div class="modal fade bd-cursos-modal" id="cursosVer" tabindex="-1" role="dialog"
            aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
