                            ...
                            <div class="card-body">
                                ...
                                <div class="row d-none">
                                    <div class="col-lg-5 col-md-4 col-sm-6">
                                        <!-- <label>Nivel </label> -->
                                        <select @change="listar_grados()" v-model="asignar.nivel"
                                    ...
                                    <div class="col-lg-2 col-md-4 col-sm-6">
                                        <a @click="buscar_data()" href="javascript:void(0);"
                                            class="btn btn-sm btn-primary btn-block" title="">Buscar</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                                            ...
                                            <tr v-for="(item, index) in data" :key="index">
                                                ...
                                                <td>
                                                    <button type="button" class="btn btn-icon btn-sm" title="Registrar"
                                                        @click="grabar_asignacion(item.pa_id)"><i
                                                            class="fa fa-save text-info"></i></button>
                                                    <button type="button" class="btn btn-icon btn-sm" title="Limpiar"
                                                        @click="eliminar_asignacion(item.pa_id)"><i
                                                            class="fa fa-trash text-danger"></i></button>
                                                </td>
                                                <td class="d-none">{{ item.dni }}</td>
                                                <td>{{ item.nombres }} {{ item.apellidos }}</td>
                                                <td v-for="(i, index) in cursos" :key="index">
                                                    <input v-if="item.checked.includes(i.cur_nombre)" class=""
                                                        type="checkbox"
                                                        @click="guardando_cursos(item.checked, i.cur_nombre)" checked>
                                                    <!-- <input v-if="i.cur_nombre == item.checked" class="" type="checkbox" @click="guardando_cursos(item.checked,i.cur_nombre)" checked> -->
                                                    <input v-else class="" type="checkbox"
                                                        @click="guardando_cursos(item.checked, i.cur_nombre)">
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                        ...
                        <div class="card">
                            <form class="card-body" @submit.prevent="agregar_asignar">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-7">
                                        <input type="text" placeholder="asignar 1, asignar 2, asignar 3 ..."
                                            class="form-control" v-model="asignar.descripcion" autofocus required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-3 col-form-label">Nro Vacantes <span
                                            class="text-danger">*</span></label>
                                    <div class="col-md-7">
                                        <input type="number" placeholder="0" class="form-control" v-model="asignar.vacantes"
                                            autofocus required>
                                    </div>
                                </div>
                                <div class="form-group row">
                        ...
                        <div class="card">
                            <form class="card-body" @submit.prevent="actualizar_asignar">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-7">
                                        <input type="text" placeholder="asignar 1, asignar 2, asignar 3 ..."
                                            class="form-control" v-model="asignar_update.descripcion" autofocus required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-3 col-form-label">Nro Vacantes <span
                                    ...
                                    <div class="col-md-7">
                                        <input type="number" placeholder="0" class="form-control"
                                            v-model="asignar_update.vacantes" autofocus required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-3 col-form-label">Grado <span class="text-danger">*</span></label>
...
export default {
    ...
    methods: {
        async guardando_cursos(oldCourses, newCourse) {
            if (!this.asignar.curso.includes(newCourse) && !oldCourses.includes(newCourse)) {
                this.asignar.curso.push(newCourse);
            } else {
                this.asignar.curso = this.asignar.curso.filter((item) => item !== newCourse);
            }
