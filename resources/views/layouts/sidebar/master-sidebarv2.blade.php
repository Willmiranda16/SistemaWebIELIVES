...
<div id="header_top" class="header_top">
    <div class="container">
        <div class="hleft">
            <a class="header-brand" href="/home">{{-- <i class="fa fa-graduation-cap brand-logo"></i> --}}<img src="assets/images/insig.png" class="" alt="logo" style="width: 80%;"></a>
            <div class="dropdown">
                <a href="javascript:void(0)" class="nav-link icon menu_toggle"><i class="fe fe-align-center"></i></a>
                <a href="page-search.html" class="nav-link icon" style="pointer-events: none;cursor: default; "><i class="fe fe-search" data-toggle="tooltip" data-placement="right" title="Search..."></i></a>
                <a href="app-email.html"  class="nav-link icon app_inbox" style="pointer-events: none;cursor: default; "><i class="fe fe-inbox" data-toggle="tooltip" data-placement="right" title="Inbox"></i></a>
                <a href="app-filemanager.html"  class="nav-link icon app_file xs-hide" style="pointer-events: none;cursor: default; "><i class="fe fe-folder" data-toggle="tooltip" data-placement="right" title="File Manager"></i></a>
                <a href="app-social.html"  class="nav-link icon xs-hide"  style="pointer-events: none;cursor: default; "><i class="fe fe-share-2" data-toggle="tooltip" data-placement="right" title="Social Media"></i></a>
                <a href="javascript:void(0)" class="nav-link icon theme_btn" style="pointer-events: none;cursor: default; "><i class="fe fe-feather"></i></a>
                <a href="javascript:void(0)" class="nav-link icon settingbar"><i class="fe fe-settings"></i></a>
            </div>
        </div>
        <div class="hright">
            <a href="javascript:void(0)" class="nav-link icon right_tab"><i class="fe fe-align-right"></i></a>
            <a class="nav-link icon" href="{{ route('logout') }}" onclick="event.preventDefault();document.getElementById('logout-form').submit();">
...
<div id="left-sidebar" class="sidebar" style="background: linear-gradient(265deg, #0093dd, #5679af);">
    <h5 class="brand-name">{{-- I.E. <br> --}}Carlos A Olivares<a href="javascript:void(0)" class="menu_option float-right"><i class="icon-grid font-16" data-toggle="tooltip" data-placement="left" title="Grid & List Toggle"></i></a></h5>
    <ul class="nav nav-tabs">
    ...
    <div class="tab-content mt-3">
        <div class="tab-pane fade show active" id="menu-uni" role="tabpanel">
            <nav class="sidebar-nav">
                <ul class="metismenu">
                    <li class="opcion_tab2 active"><a class="opcion_tab" data-toggle="tab" id="home_tab"  href="#home" onclick="evaluar_opciones()"><i class="fa fa-dashboard"></i><span>Inicio</span></a></li>
                    <li class="opcion_tab2"><a class="opcion_tab" data-toggle="tab" id="usuarios_tab" href="#usuarios" onclick="evaluar_opciones()"><i class="fa fa-user-circle-o"></i><span>Usuarios</span></a></li>
                    <li class="opcion_tab2"><a class="opcion_tab" data-toggle="tab" id="periodos_tab" href="#periodos" onclick="evaluar_opciones()"><i class="fa fa-calendar-check-o"></i><span>Periodos</span></a></li>
                    <li class="opcion_tab2"><a class="opcion_tab" data-toggle="tab" id="alumnos_tab" href="#alumnos" onclick="evaluar_opciones()"><i class="fa fa-users"></i><span>Alumnos</span></a></li>
                    <li class="opcion_tab2"><a class="opcion_tab" data-toggle="tab" id="matriculas_tab" href="#matriculas" onclick="evaluar_opciones()"><i class="fa fa-book"></i><span>Matriculas</span></a></li>
                </ul>
            </nav>
        </div>
