<div class="sidebar">
    <!-- Start Logobar -->
    <div class="logobar">
        <a href="/home" class="logo logo-large"><img src="assets/images/insig.png" class="img-fluid" alt="logo"></a>
        <a href="index.html" class="logo logo-small"><img src="assets/images/icono.png" class="img-fluid" alt="logo"></a>
    </div>
    <!-- End Logobar -->
    <!-- Start Navigationbar -->
        ...
        <ul class="vertical-menu in">
            <li>
                <a href="javaScript:void();">
                  <img src="assets/images/svg-icon/user.svg" class="img-fluid" alt="dashboard"><span>Usuarios</span><i class="feather icon-chevron-right pull-right"></i>
                </a>
