    ...
    <div class="row align-items-center">
        <div class="col-md-12">
            <div class="mobile-logobar">
                <a href="/home" class="mobile-logo"><img src="assets/images/icono.png" class="img-fluid" alt="logo" style="width: 15%"></a>
            </div>
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="profilelink">
                                    ...
                                    <div class="userbox">
                                        <ul class="list-unstyled mb-0">
                                            <li class="media dropdown-item">
                                                <a href="#" class="profile-icon"><img src="assets/images/svg-icon/user.svg" class="img-fluid" alt="user">Mi Perfil</a>
                                            </li>
                                            <li class="media dropdown-item">
                                                <a href="#" class="profile-icon"><img src="assets/images/svg-icon/email.svg" class="img-fluid" alt="email">Correo</a>
                                            </li>
                                            <li class="media dropdown-item">
                                                {{-- <a href="#" class="profile-icon"><img src="assets/images/svg-icon/logout.svg" class="img-fluid" alt="logout">Salir</a> --}}
                                                <a class="profile-icon" href="{{ route('logout') }}" onclick="event.preventDefault();document.getElementById('logout-form').submit();">
                                                    <img src="assets/images/svg-icon/logout.svg" class="img-fluid" alt="logout">{{ __('Cerrar Sesión') }}
                                                </a>
