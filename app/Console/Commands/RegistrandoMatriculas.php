...
class RegistrandoMatriculas extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'go:matricular';
     ...
     * @var string
     */
    protected $description = 'Comando para registrar información de la matricula de los estudiantes del nivel secundario - CAO';
    ...
    public function handle()
    {
        ...
        $filename = "Reporte_Informacion_Matricula_Estudiantes.txt";
        ...
        while($numero <= $rows){
            ...
            if($dni){
                JhonHelper::maticularAlumnos($hojaActual,$numero,$filename);
            }
